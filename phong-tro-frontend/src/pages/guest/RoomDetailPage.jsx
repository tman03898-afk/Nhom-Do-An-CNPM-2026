      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
         ...
         <div className="lg:col-span-2 bg-white/40 backdrop-blur-[16px] border border-white/60 rounded-[3rem] p-8 md:p-12">
            ...
            <div className="mb-10">
               ...
               <div className="text-4xl md:text-5xl font-sans font-bold text-[#14B8A6]">8.500.000đ</div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 py-8 border-y border-[#CFE8EA]/80 mb-10">
              <div>
                ...
                <div className="flex items-center gap-2 font-bold text-nest-text-primary text-base"><Ruler className="w-5 h-5 text-[#14B8A6]"/> 35 m²</div>
              </div>
              <div>
                <div className="text-[10px] font-bold text-nest-text-secondary uppercase tracking-wider mb-2">Loại phòng</div>
                <div className="flex items-center gap-2 font-bold text-nest-text-primary text-base"><LayoutGrid className="w-5 h-5 text-[#14B8A6]"/> Studio</div>
              </div>
              <div>
            ...
            <p className="text-sm text-nest-text-secondary leading-[1.8] pr-4">
              Căn hộ được thiết kế theo phong cách tối giản Bắc Âu (Scandinavian), tối ưu hóa ánh sáng tự nhiên với ban công rộng hướng ra phía Đông, không gian sống yên tĩnh, phù hợp cho sinh viên hoặc nhân viên văn phòng cần sự tập trung và thư giãn sau giờ làm việc. Nội thất hoàn toàn mới, được chọn lọc kỹ lưỡng từ các thương hiệu cao cấp.
            </p>
         </div>
