...
export default function TenantTicketPage() {
  ...
  return (
    <div className="flex flex-col gap-8 pb-10">
       {/* Header */}
       <div>
          <h1 className="text-[34px] font-sans font-bold text-[#0F3A40] tracking-tight">Báo cáo sự cố</h1>
          ...
          <div className="flex-1 bg-white/60 backdrop-blur-md rounded-[40px] p-10 border border-white shadow-sm h-fit">
             <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-3">
                   ...
                   <div 
                      className={`relative h-[220px] rounded-[32px] border-2 border-dashed transition-all flex flex-col items-center justify-center bg-[#F2FCFD]/40 ${
