...
import { Eye, EyeOff, LogIn, Mail, Sun } from 'lucide-react';
...
export default function LoginForm({
  ...
  return (
    <div className={`w-full max-w-[460px] bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-10 md:p-12 border border-white shadow-2xl shadow-nest-primary/5 transition-all duration-500 ${className}`}>
      <div className="flex flex-col items-center mb-10 text-center">
        ...
        <p className="text-nest-text-secondary font-medium text-sm mt-2">
          Nơi khởi đầu của những trải nghiệm sống chất
        </p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center px-1">
            <label className="text-[11px] font-bold text-nest-text-primary uppercase tracking-[0.2em]">
              Mật khẩu
            </label>
            <Link
              to="/forgot-password"
        ...
        <button
          ...
          className="w-full h-15 py-4 rounded-full bg-nest-primary hover:bg-[#0fa696] text-white font-bold text-base shadow-xl shadow-nest-primary/20 transition-all flex items-center justify-center gap-3 active:scale-[0.98] group disabled:opacity-70 disabled:cursor-not-allowed"
        >
